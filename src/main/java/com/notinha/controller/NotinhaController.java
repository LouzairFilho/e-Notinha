...
//	public String getNotinhaString() {
//		if(this.notinhaBean.getItemNotinha().size()>0){
//		this.notinhaString = "N° nota: "+this.notinhaBean.getId() +"/n "+
//							 "Cliente: "+this.notinhaBean.getCliente().getNomeRazao() +"/n "+
//							 "Fantasia: "+this.notinhaBean.getCliente().getNomeFantasia() +"/n "+
//							 "Valor: "+this.notinhaBean.getValorNotinha() +"/n ";
//		}
//		return notinhaString;
//	}
//
//	public void setNotinhaString(String notinhaString) {
//		this.notinhaString = notinhaString;
//	}
